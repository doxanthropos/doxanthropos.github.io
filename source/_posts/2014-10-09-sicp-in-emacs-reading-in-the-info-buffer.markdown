...
<!-- more -->
In the search for information on info, I found that there is a lot of documentation missing from my relatively recent Debian install. Most of the more interesting parts on info are in the package "texinfo-doc-nonfree". I suggest to install it on every system, because the [info system](http://www.gnu.org/software/texinfo/manual/texinfo/html_node/index.html) is very cool and it is very rewarding t read its manual. What I don't understand is the "nonfree" part: should it not be free software as a part of the GNU-project?
